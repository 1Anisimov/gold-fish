      ...
      <div className="header_bottom">
        <div className="container_main">
          <div className="header_bottom_container">
            <button onClick={onChange} className="header_bottom_item header_bottom_catalog links">
              <svg
                className="me-3"
                width="16"
                height="14"
                ...
                <rect y="6" width="16" height="2" fill="currentColor"></rect>
                <rect y="12" width="16" height="2" fill="currentColor"></rect>
              </svg>
              <span>Каталог</span>
            </button>
            <Link
              to="/catalog/warhammer"
              className="header_bottom_nav_item header_bottom_nav_item_1 links">
              Wharhammer
            </Link>
            <Link
              to="/catalog/magic"
              className="header_bottom_nav_item header_bottom_nav_item_2 links">
              Magic:the Cathering
            </Link>
            <Link to={''} className="header_bottom_nav_item header_bottom_nav_item_3 links">
              Мероприятия
            </Link>
            <Link to={''} className="header_bottom_nav_item header_bottom_nav_item_4 links">
              О центре
            </Link>
            <Link to={''} className="header_bottom_nav_item header_bottom_nav_item_5 links">
              Контакты
            </Link>
            ...
            <div className="header_bottom_item header_bottom_item_icons">
              <div className="header_bottom_item_icons_inst">
                <svg
                  ...
                  viewBox="0 0 23 23"
                  fill="none">
                  <g clipPath="url(#clip0_12297_2835)">
                    <path

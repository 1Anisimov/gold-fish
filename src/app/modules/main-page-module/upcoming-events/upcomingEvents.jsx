...
import cls from './upcoming-events.module.css';
import imgLeft from '../../../image/img_events_1.png';
import imgRight from '../../../image/img_events_2.png';
import CardEvents from '../events-card/events-card';
import MainButton from '../../../reusable-components/main-button';

const UpcomingEvents = () => {
  return (
    <>
      <div className={cls.upcoming_events}>
        <div className={cls.upcoming_events_top}>
          <h2 className={cls.upcoming_events_h2}>Ближайшие мероприятия</h2>
          <div className={cls.upcoming_events_block}>
            <CardEvents
        ...
        <div className={cls.upcoming_events_block_button}>
